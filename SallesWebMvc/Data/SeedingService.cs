...
using SallesWebMvc.Models.Enumerator;
using System;
...
namespace SallesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(200, 1, 9), 4000.00, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);
